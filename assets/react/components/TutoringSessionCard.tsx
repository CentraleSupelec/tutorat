...
export default function ({tutoringSession}) {
    ...
    const { displayTutoringSessionDate, displayRoom } = Utils();

    const displayTutors = (tutoringSession: TutoringSession) => {
                        ...
                        <div className="d-flex flex-column">
                            <div className="d-flex align-items-center">
                                ...
                                <h6 className="tutoring-title bold mb-0">
                                    { displayTutoringSessionDate(tutoringSession)}
                                </h6>
                                { tutoringSession.isRemote ?
                                    ...
                                    <div>
                                        ...
                                        <span className="tutoring-session-description bold">
                                            {t('tutor.default_room')} : { tutoringSession.room && tutoringSession.building ? displayRoom(tutoringSession) : t('utils.to_complete')}
                                        </span>
                                    </div>
                                }
                            </div>
